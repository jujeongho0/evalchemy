...
답변은 반드시 다음 형식을 엄격히 지켜야 합니다: "정답은 {{정답 보기}}입니다."로 끝나야하고, {{정답 보기}}는 A, B, C, D, E, F, G, H, I, J 중 하나여야 합니다.
...
class KoBALTBenchmark(BaseBenchmark):
    ...
    def load_questions(self) -> List[Dict[str, Any]]:
        dataset = load_dataset(self.dataset_name, "kobalt_v1", cache_dir=HF_HUB_CACHE)
